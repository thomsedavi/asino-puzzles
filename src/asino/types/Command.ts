...
export type CommandResult = {
  letter?: Letter;
  [X]?: NumberResult; // if this exists, draw the rectangle here, or...
  [X1]?: NumberResult; // if this exists, draw x1 here, or...
  [X2]?: NumberResult; // if this exists, draw x2 here, or...
  [Y]?: NumberResult; // if this exists, draw the rectangle here, or...
  [Y1]?: NumberResult; // if this exists, draw y1 here, or...
  [Y2]?: NumberResult; // if this exists, draw y2 here, or...
  [DX]?: NumberResult; // if this exists, draw the rectangle here, or...
  [DX1]?: NumberResult; // if this exists, draw the rectangle here, or...
  [DX2]?: NumberResult; // if this exists, draw the rectangle here, or...
  [DY]?: NumberResult; // if this exists, draw the rectangle here, or...
  [DY1]?: NumberResult; // if this exists, draw the rectangle here, or...
  [DY2]?: NumberResult; // if this exists, draw the rectangle here, or...
}
